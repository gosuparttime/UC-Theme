...
<div id="tribe-events-bar">
	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_attr( $current_url ); ?>">
		...
		<div id="tribe-bar-views" class="col-xs-15 col-sm-4 col-sm-push-11">
		...
		<div class="tribe-bar-filters col-xs-15 col-sm-11 col-sm-pull-4">
			<div class="tribe-bar-filters-inner tribe-clearfix">
				...
				<div class="tribe-bar-submit">
					<button type="submit" class="search-submit btn btn-primary"><?php _e('<i class="fa fa-search"></i>Find Events', 'tribe-events-calendar'); ?></button>
