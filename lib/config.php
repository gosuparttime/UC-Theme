...
function ucmaster_main_class() {
  if (ucmaster_display_sidebar()) {
    ...
    $class = 'col-md-11 col-sm-10 col-xs-15';
  } else {
 ...
 */
function ucmaster_display_sidebar() {
  $sidebar_config = new ucmaster_Sidebar(
    /**
  ...
  return apply_filters('ucmaster/display_sidebar', $sidebar_config->display);
}
